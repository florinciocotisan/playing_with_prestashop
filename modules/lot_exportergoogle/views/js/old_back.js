...
url=modulepath+'ajax.php?savefeed=1&secure_key='+$('#sodcheiesig').val();
...
$.ajax({
  ...
  cache: false, 
  dataType : "text",
  data: 'feedcontent='+feeddata+'&feeddatahtml='+feeddatahtml+'&capuritabel='+capuritabel+'&fieldseparator='+fieldseparator+'&valueseparator='+valueseparator+'&feedheader='+feedheader+'&feedfooter='+feedfooter+'&feedname='+feedname+'&feedid='+feedid+'&type='+$('#feedtype').val()+'&restrictions='+restrictions+'&token='+$('#sodcheiesig').val(),
  success: function(response)
				{
                    ...
                    initializefeed(response,0,exportasfile);
...
url=modulepath+'ajax.php?putrestrictions=1&secure_key='+cheiesec;    
...
$.ajax({
  ...
  cache: false, 
  dataType : "text",
  data: 'feedrestrictionshtml='+restrictionshtml+'&updatedfeed='+idfeed+'&token='+cheiesec,
  success: function(response)
				{
...
url=modulepath+'ajax.php?deletefeed='+idfeed+'&secure_key='+$('#sodcheiesig').val();    
...
$.ajax({
  ...
  cache: false, 
  dataType : "text",
  data: 'deletefeed='+idfeed+'&token='+$('#sodcheiesig').val(),
  success: function(response)
				{
...
if (exportasfile == 0) {    
$('#viewfeed a').attr('href','../modules/lot_exportergoogle/feed.php?id_feed='+idfeed);
}
else {
$('#viewfeed a').hide();   
top.location.href = modulepath+'download.php?id_feed='+idfeed;
}
