...
class Lot_ExporterGoogleDownloadModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        header('Content-Disposition: attachment; filename='.'feed_'.$id_feed.'.xml');
        readfile(_PS_MODULE_DIR_.'lot_exportergoogle/feeds/feed_'.$id_feed.'.xml');    
